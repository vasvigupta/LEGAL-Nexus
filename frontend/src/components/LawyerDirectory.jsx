    ...
    <div className="space-y-4">
      ...
      <div className="bg-[#0B1F33] text-white p-4 sm:p-5 rounded-2xl border border-slate-800 shadow-legal flex flex-col md:flex-row md:items-center justify-between gap-3">
        ...
        <button
          ...
          className="btn-shimmer px-5 py-2.5 bg-gradient-to-r from-legal-blue to-blue-700 hover:from-blue-600 hover:to-blue-800 text-white font-bold text-xs rounded-xl shadow-md transition flex items-center justify-center gap-2 shrink-0 transform active:scale-95"
        >
